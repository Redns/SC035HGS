...
/* Definitions for peripheral AXI_GPIO_AXISBUFW_CTRL */
#define XPAR_AXI_GPIO_AXISBUFW_CTRL_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_AXISBUFW_CTRL_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_AXISBUFW_CTRL_DEVICE_ID 0
#define XPAR_AXI_GPIO_AXISBUFW_CTRL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_AXISBUFW_CTRL_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_AXISBUFW_DATA */
#define XPAR_AXI_GPIO_AXISBUFW_DATA_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_AXISBUFW_DATA_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_AXISBUFW_DATA_DEVICE_ID 1
#define XPAR_AXI_GPIO_AXISBUFW_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_AXISBUFW_DATA_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_AXISBUFW_CTRL */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_AXISBUFW_CTRL_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_AXISBUFW_DATA */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_AXISBUFW_DATA_DEVICE_ID
