...
HD_PWD='E:/Project/sc_camera/code/dma_pl2ps/dma_pl2ps.runs/system_ui_axisbufw_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ui_axisbufw_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ui_axisbufw_0_0.tcl
