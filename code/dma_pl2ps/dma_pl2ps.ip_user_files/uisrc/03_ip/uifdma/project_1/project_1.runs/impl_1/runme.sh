...
HD_PWD='G:/V2020/S02/02_example_fdma_ddr_2/01_fdma_ddr_test_new/uisrc/03_ip/uifdma/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uiFDMA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uiFDMA.tcl -notrace
