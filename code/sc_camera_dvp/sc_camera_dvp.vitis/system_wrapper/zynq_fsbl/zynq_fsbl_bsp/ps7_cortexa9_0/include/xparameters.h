...
#define XPAR_AXIS_TRANSMIT_ENABLE_HIGHADDR 0x4120FFFF
#define XPAR_AXIS_TRANSMIT_ENABLE_DEVICE_ID 0
#define XPAR_AXIS_TRANSMIT_ENABLE_INTERRUPT_PRESENT 0
#define XPAR_AXIS_TRANSMIT_ENABLE_IS_DUAL 0
...
/* Definitions for peripheral CAMERA_RESET */
#define XPAR_CAMERA_RESET_BASEADDR 0x41220000
#define XPAR_CAMERA_RESET_HIGHADDR 0x4122FFFF
#define XPAR_CAMERA_RESET_DEVICE_ID 2
#define XPAR_CAMERA_RESET_INTERRUPT_PRESENT 0
#define XPAR_CAMERA_RESET_IS_DUAL 0
...
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXIS_TRANSMIT_ENABLE_DEVICE_ID
...
/* Canonical definitions for peripheral CAMERA_RESET */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_CAMERA_RESET_DEVICE_ID
