...
fpga -file E:/Project/sc_camera/code/sc_camera_dvp/sc_camera_dvp.vitis/sc_camera_dvp/_ide/bitstream/system_wrapper_with_ila.bit
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw E:/Project/sc_camera/code/sc_camera_dvp/sc_camera_dvp.vitis/system_wrapper/export/system_wrapper/hw/system_wrapper_with_ila.xsa -mem-ranges [list {0x40000000 0xbfffffff}] -regs
