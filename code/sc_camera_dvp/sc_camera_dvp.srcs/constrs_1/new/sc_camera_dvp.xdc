...
set_property PACKAGE_PIN AC13 [get_ports {i_camera_vsync[0]}]
...
set_property PACKAGE_PIN AD16 [get_ports {o_camera_pwdn[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {o_camera_pwdn[0]}]

# Camera sc035hgs reset
set_property PACKAGE_PIN AD15 [get_ports {o_camera_reset[0]}]
