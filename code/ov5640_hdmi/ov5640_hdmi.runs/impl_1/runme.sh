...
HD_PWD='E:/Project/sc_camera/code/20220731ygACd6Xc/ov5640_hdmi_1_3/ov5640_hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_hdmi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov5640_hdmi_wrapper.tcl -notrace
